...
High AUC doesn't guarantee good calibration, which is critical for
...
plt.tight_layout()
plt.savefig('figures/model_calibration.png', dpi=300, bbox_inches='tight')
print("\nCalibration plot saved: figures/model_calibration.png")
plt.close()
...
print("\nSaved: outputs/tables/model_calibration_results.csv")
