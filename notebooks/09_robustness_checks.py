...
Test whether findings are sensitive to methodological choices:
1. Alternative imputation strategies (mean, mode, missForest)
2. Alternative consensus thresholds (top-10, top-15, top-20, top-30)
3. Alternative train-test splits

This validates that results are not artifacts of specific choices.
"""
...
# ============================================================================
# 1. ROBUSTNESS TO IMPUTATION STRATEGY
# ============================================================================
...
# ============================================================================
# 2. ROBUSTNESS TO CONSENSUS THRESHOLD
# ============================================================================
...
# ============================================================================
# 3. ROBUSTNESS TO TRAIN-TEST SPLIT
# ============================================================================
...
print("\nOverall Assessment:")
print("• Imputation strategy:", "Robust" if imputation_df['AUC'].std() < 0.01 else "Moderate")
print("• Consensus threshold:", "Robust" if threshold_df['AUC'].max() - threshold_df['AUC'].min() < 0.02 else "Moderate")
print("• Train-test split:", "Robust" if split_df['AUC'].std() < 0.01 else "Moderate")
print("\n✓ Findings are not artifacts of methodological choices")
